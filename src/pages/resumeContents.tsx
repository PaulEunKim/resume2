    ...
    "experience": {
      ...
      "description": [
        [
          ...
          Produced a successful and replicable object detection workflow using convolutional neural networks in ArcGIS for counting corn plants from drone images; setting a pathway to automate the process that was previously done by hand and presented findings to Beck’s Hybrid’s team and the National Data Mine Network
          </ListItem>
